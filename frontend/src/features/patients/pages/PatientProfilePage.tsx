        ...
        <section className={styles.archiveSection}>
          {!archiveConfirm ? (
            ...
            <div className={styles.archiveConfirm}>
              <span>
                {language === "ar"
                  ? "سيختفي المريض من القوائم اليومية مع الاحتفاظ بكل تاريخه وسجل عملياته."
                  : "The patient will leave operational lists while all historical records are preserved."}
              </span>
