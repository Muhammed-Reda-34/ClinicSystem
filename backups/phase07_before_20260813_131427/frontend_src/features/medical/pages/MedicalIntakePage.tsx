...
export function MedicalIntakePage() {
  ...
  if (query.isError) {
    return (
      <div className={styles.state}>
        {language === "ar"
          ? "ØªØ¹Ø°Ø± ØªØ­Ù…ÙŠÙ„ Ø§Ù„Ø§Ø³ØªÙ…Ø§Ø±Ø©."
      ...
      >
        <section className={styles.card}>
          <div className={styles.cardHeader}>
            ...
            <div>
              ...
              <p>
                {language === "ar"
                  ? "ØªÙØ³ØªÙƒÙ…Ù„ Ø¹Ù†Ø¯ Ø­Ø¶ÙˆØ± Ø§Ù„Ù…Ø±ÙŠØ¶ Ù„Ù„Ø¹ÙŠØ§Ø¯Ø©."
        ...
        <section className={styles.card}>
          <div className={styles.cardHeader}>
            ...
            <div>
              ...
              <p>
                {language === "ar"
                  ? "Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„ØµØ­ÙŠØ© Ù…Ø£Ø®ÙˆØ°Ø© Ù…Ù† Ø§Ù„Ø§Ø³ØªÙ…Ø§Ø±Ø© Ø§Ù„Ù…Ø±ÙÙ‚Ø©."
        ...
        {mutation.isError && (
          <div className={styles.error}>
            {language === "ar"
              ? "ØªØ¹Ø°Ø± Ø­ÙØ¸ Ø§Ù„Ø§Ø³ØªÙ…Ø§Ø±Ø©. Ø±Ø§Ø¬Ø¹ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª ÙˆØ­Ø§ÙˆÙ„ Ù…Ø±Ø© Ø£Ø®Ø±Ù‰."
