        ...
        if (!string.IsNullOrWhiteSpace(search))
        {
            ...
            query = query.Where(patient =>
                ...
                || EF.Functions.ILike(
                    ...
                    $"%{term}%")
                || (
                    phoneCandidate1.Length >= 3
                    && patient.NormalizedPhone
                        .Contains(phoneCandidate1)
                )
                || (
                    phoneCandidate2.Length >= 3
                    && patient.NormalizedPhone
                        .Contains(phoneCandidate2)
                )
                || (
                    phoneCandidate3.Length >= 3
                    && patient.NormalizedPhone
                        .Contains(phoneCandidate3)
                ));
        }
